...
public class RedDoubleSteal extends SequentialCommandGroup {
    public RedDoubleSteal(
        ...
        addCommands(
            ...
            new IntakePath(PATH_TO_BLUE_2, drivetrain, intake, pistons), //Intake Red 2
            new AimRoutine(drivetrain, hood, flywheel, vision), //Aim
            new FireRoutine(flywheel, hood, accelerator, 0.5), //Fire Red 1 & 2
            new IntakePath(PATH_TO_RED_1, drivetrain, intake, pistons), //Intake Blue 1
            ...
            new IntakePath(PATH_TO_RED_2, drivetrain, intake, pistons), //Intake Blue 2
            new ParallelCommandGroup(//Arrange Shooter
